            ...
            <div className='login-container'>
                ...
                <div className='form-container'>
                    <Form onSubmit={formData.handleSubmit}>
                        ...
                        <FormGroup>
                            <Label className='ms-1'>License Number</Label>
                            <Input
                                id='licenseNumber'
                                name="licenseNumber"
                                type='text'
                                onChange={formData.handleChange}
                                onBlur={formData.handleBlur}
                                value={formData.values.licenseNumber}
                            />
                        </FormGroup>
                        <FormGroup>
                            <Label className='ms-1'>Hospital</Label>
                            <Input
                                id='hospital'
                                name="hospital"
                                type='text'
                                onChange={formData.handleChange}
                                onBlur={formData.handleBlur}
                                value={formData.values.hospital}
                            />
                        </FormGroup>
                        <FormGroup>
                            <Label className='ms-1'>Specialization</Label>
                            <Input
                                id='specialization'
                                name="specialization"
                                type='text'
